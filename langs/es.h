...
msgstr("Transferencia de archivos rota")
...
msgid(CALL_INVITED)
msgstr("Llamada invitada")

msgid(CALL_RINGING)
msgstr("Llamada sonando")
...
msgid(CLOSE_TO_TRAY)
msgstr("Ocultar en la bandeja al cerrar")
...
msgstr("Copiar (sin nombres)")

msgid(COPY_WITH_NAMES)
msgstr("Copiar (incluir nombres)")
